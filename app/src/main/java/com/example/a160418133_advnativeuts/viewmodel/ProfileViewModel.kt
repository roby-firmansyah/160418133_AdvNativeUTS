...
class ProfileViewModel: ViewModel() {
    ...
    fun fetch(username:String) {
        val user = Users(username,"Roby Firmansyah","29 November 1999","081330946701","https://media.discordapp.net/attachments/823023798730096660/896006487787311124/1.jpg")
        profile.value = user
    }
}